              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color:
                          state.hasError ? Colors.red : const Color(0xFFC4C4C4),
                      width: 1.0,
                    ),
                  ),
                  child: Material(
...
// Identify which items use FontAwesome
  final Set<String> fontAwesomeItems = {'Member', 'PR', 'HR'};
  Widget? _buildLeadingIcon(String item) {
    if (itemIcons != null && itemIcons!.containsKey(item)) {
      final iconData = itemIcons![item];

      if (iconData is IconData) {
        if (fontAwesomeItems.contains(item)) {
          return FaIcon(
            iconData,
            size: 15,
            color: itemColor,
